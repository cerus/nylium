...
public final class HeightmapArray implements Cloneable {
    ...
    public HeightmapArray() {
        this(9, 256);
    }

    private HeightmapArray(final int bitsPerValue, final int capacity) {
     ...
     */
    public HeightmapArray resize(final int newBitsPerValue) {
        if (newBitsPerValue == this.bitsPerValue) {
            return this;
        }

        final HeightmapArray returned = new HeightmapArray(newBitsPerValue, this.capacity);
    ...
    @Override
    public HeightmapArray clone() {
        final HeightmapArray clone = new HeightmapArray(this.bitsPerValue, this.capacity);
